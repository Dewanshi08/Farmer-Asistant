<?php
	...
	$query = "SELECT * FROM temp_seller_reg WHERE confirm_code='$confirm_code'";
	...
	$lname="";
		...
		{ 
			...
			$query1 = "INSERT INTO seller_reg (s_id,first_name, last_name, mobile_no, email, flat_no, building_name, street_no, street_name, city, pincode, state,aadhaar_no, password) VALUES('0','$fname', '$lname', '$mobile', '$email' , '$building_no', '$building_name', '$street_no', '$street_name', '$city', '$p_code', '$state', '$aadhar','$password')";
	 		$conn -> query($query1);
		}

	$sql = "DELETE FROM temp_seller_reg WHERE confirm_code='$confirm_code'";
	$conn -> query($sql);
